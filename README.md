...
**ORG_TEMPLATE** - Organization template used during initialization to preconfigure the workspace.
- Example: `smart_building` or `smart_fleet_monitor`
